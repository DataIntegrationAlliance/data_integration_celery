...
if __name__ == '__main__':
    ...
    log.addHandler(ch)
    selected_hosts=[('上证云北京联通一', '123.125.108.14', 7709), ('上海电信主站Z1', '180.153.18.170', 7709), ('上海电信主站Z2', '180.153.18.171', 7709),
                    ('上海电信主站Z80', '180.153.18.172', 80), ('北京联通主站Z1', '202.108.253.130', 7709), ('北京联通主站Z2', '202.108.253.131', 7709),
                    ('北京联通主站Z80', '202.108.253.139', 80), ('杭州电信主站J1', '60.191.117.167', 7709), ('杭州电信主站J2', '115.238.56.198', 7709),
                    ('杭州电信主站J3', '218.75.126.9', 7709), ('杭州电信主站J4', '115.238.90.165', 7709), ('杭州联通主站J1', '124.160.88.183', 7709),
                    ('杭州联通主站J2', '60.12.136.250', 7709),  ('青岛联通主站W1', '218.57.11.101', 7709), ('青岛电信主站W1', '58.58.33.123', 7709),
                    ('深圳电信主站Z1', '14.17.75.71', 7709), ('云行情上海电信Z1', '114.80.63.12', 7709),('云行情上海电信Z2', '114.80.63.35', 7709),
    ...
    with api.connect(primary_ip, hot_backup_ip):
        ...
        df = api.to_df(api.get_history_transaction_data(TDXParams.MARKET_SZ, '000757', 0, 30000, int('20000323')))
