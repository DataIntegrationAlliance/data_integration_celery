...
df= pro.fut_basic(exchange='DCE',fields=field)
...
def import_tushare_daily_basic(chain_param=None):
    ...
    field='ts_code,symbol,exchange,name,fut_code,trade_unit,per_unit,quote_unit,quote_unit_desc,d_mode_desc,\
    list_date,delist_date,d_month,last_ddate,trade_time_desc,trade_time_desc'
    try:
